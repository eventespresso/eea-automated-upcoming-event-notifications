...
// - 1 notification to the Event Admin for Automated Upcoming Event message type.
// - 1 notification to the Event Admin for Automated Upcoming Datetime message type.
