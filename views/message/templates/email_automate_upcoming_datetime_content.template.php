                        ...
                        <td>
                            ...
                            <p class="lead">
                                <?php
                                    printf(
                                        esc_html__(
                                            "We're reaching out to remind you of an upcoming event you registered for on our website. You have access to this event on %s. Here's a copy of your registration details:",
                                            'event_espresso'
                                        ),
