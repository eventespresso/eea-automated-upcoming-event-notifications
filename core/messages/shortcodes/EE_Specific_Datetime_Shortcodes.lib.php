...
class EE_Specific_Datetime_Shortcodes extends EE_Shortcodes
{
    protected function _init_props()
    {
        ...
        $this->_shortcodes = array(
            ...
            '[IF_DATETIME_*]' => esc_html__(
                'A special conditional type shortcode that allows people to have content that is conditional'
                . ' in the templates.  Note correct usage is `[IF_DATETIME_* DTT_ID=10]Content specific to when the'
                . ' datetime has an id of 10[/IF_DATETIME_*]`. Note  you can use `preview_show` or `preview_hide` as the'
                . ' value of DTT_ID to simulate conditional behaviour in previews when viewing templates.',
                'event_espresso'
            )
        );
    }
