...
class SchedulingSettings
{
    ...
    /**
     * Sets the days beofre threshold to the provided value.
     * @param int   $new_threshold
     * @return int|bool    @see EE_Base_Class::update_extra_meta
     */
    ...
    public function isActive()
    {
        if (! isset($this->cache[SchedulingSettings::AUTOMATION_ACTIVE])) {
            $this->cache[SchedulingSettings::AUTOMATION_ACTIVE] = (bool)$this->message_template_group->get_extra_meta(SchedulingSettings::AUTOMATION_ACTIVE, true, false);
        }
