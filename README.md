EE Automated Upcoming Event Notifications Add-on
=========================================================

[![Latest Release](https://img.shields.io/github/tag/eventespresso/eea-automated-upcoming-event-notifications.svg?style=flat&label=Latest%20Release)](https://github.com/eventespresso/eea-automated-upcoming-event-notifications/releases)
...
> **Important:** This addon has not been released yet so links in this readme likely will not resolve.
